...
const voedingsmiddelen = [
  ...
  // Groenten
  { naam: 'Wortel', emoji: '🥕', status: 'groen', engelsNaam: 'carrot', zoektermen: ['worteltje', 'winterwortel', 'wortelen'], notitie: 'Veilig in normale hoeveelheden.' },
  { naam: 'Courgette', emoji: '🥒', status: 'groen', engelsNaam: 'zucchini', zoektermen: ['zucchini', 'courget'], notitie: 'Veilig tot ca. 65 gram per portie.' },
  { naam: 'Komkommer', emoji: '🥒', status: 'groen', engelsNaam: 'cucumber', zoektermen: ['komkommers'], notitie: 'Veilig in normale hoeveelheden.' },
  { naam: 'Rode paprika', emoji: '🫑', status: 'groen', engelsNaam: 'red bell pepper', zoektermen: ['paprika', 'rode paprika', 'peper'], notitie: 'Veilig in matige hoeveelheden.' },
  { naam: 'Groene paprika', emoji: '🫑', status: 'groen', engelsNaam: 'green bell pepper', zoektermen: ['paprika', 'groene peper'], notitie: 'Veilig in matige hoeveelheden.' },
  { naam: 'Sla', emoji: '🥬', status: 'groen', engelsNaam: 'lettuce', zoektermen: ['slablaadjes', 'salade', 'ijsbergsla', 'rucola'], notitie: 'Veilig in normale hoeveelheden.' },
  ...
  { naam: 'Boerenkool', emoji: '🥬', status: 'groen', engelsNaam: 'kale', zoektermen: ['kale', 'boerenkoolstamppot'], notitie: 'Veilig in normale hoeveelheden.' },
  { naam: 'Tomaat', emoji: '🍅', status: 'groen', engelsNaam: 'tomato', zoektermen: ['tomaatje', 'cherry tomaat', 'roma tomaat', 'tomaten'], notitie: 'Veilig (max 1 kleine of 65 g per portie).' },
  { naam: 'Aubergine', emoji: '🍆', status: 'groen', engelsNaam: 'eggplant', zoektermen: ['eggplant', 'melanzaan'], notitie: 'Veilig in normale hoeveelheden.' },
  ...
  { naam: 'Zoete aardappel', emoji: '🍠', status: 'groen', engelsNaam: 'sweet potato', zoektermen: ['bataat', 'sweet potato'], notitie: 'Veilig in kleine hoeveelheden (max 75 g).' },
  { naam: 'Sperzieboon', emoji: '🫛', status: 'groen', engelsNaam: 'green bean', zoektermen: ['boontje', 'boontjes', 'haricots verts', 'snijboon'], notitie: 'Veilig in normale hoeveelheden.' },
  ...
  { naam: 'Pastinaak', emoji: '🥕', status: 'groen', engelsNaam: 'parsnip', zoektermen: ['pastinaken'], notitie: 'Veilig in normale hoeveelheden.' },
  { naam: 'Raap', emoji: '🥕', status: 'groen', engelsNaam: 'turnip', zoektermen: ['rapen', 'knolraap'], notitie: 'Veilig (max ½ stuks).' },
  { naam: 'Pompoen', emoji: '🎃', status: 'groen', engelsNaam: 'pumpkin', zoektermen: ['butternut pompoen', 'flespompoen', 'kabocha'], notitie: 'Veilig (max ⅓ kopje, bijv. Japanse of Kent pompoen).' },
  ...
  { naam: 'Broccoli', emoji: '🥦', status: 'geel', engelsNaam: 'broccoli', zoektermen: ['broccolikoppen', 'brocolli'], notitie: 'Kleine hoeveelheden (max ¾ kopje roosjes). De stengels bevatten meer FODMAP.' },
  { naam: 'Maïs', emoji: '🌽', status: 'geel', engelsNaam: 'corn', zoektermen: ['suikermaïs', 'maïskolf', 'sweetcorn', 'corn'], notitie: 'Kleine hoeveelheden (max ½ maïskolf of ½ kopje).' },
  { naam: 'Kikkererwten', emoji: '🫘', status: 'geel', engelsNaam: 'chickpeas', zoektermen: ['kikkererwt', 'chickpeas', 'hummus', 'garbanzo'], notitie: 'Kleine hoeveelheden (max ¼ kopje, ingeblikt en afgespoeld).' },
  ...
  { naam: 'Rode biet', emoji: '🫚', status: 'geel', engelsNaam: 'beetroot', zoektermen: ['bietjes', 'bieten', 'beetroot', 'biet'], notitie: 'Kleine hoeveelheden (max 2 plakjes ingeblikt).' },
  { naam: 'Venkel', emoji: '🌿', status: 'geel', engelsNaam: 'fennel', zoektermen: ['venkelknol', 'fennel', 'venkelstengel'], notitie: 'Kleine hoeveelheden (max ½ kopje). De blaadjes zijn veilig.' },
  { naam: 'Doperwt', emoji: '🫘', status: 'geel', engelsNaam: 'green peas', zoektermen: ['erwten', 'doperwten', 'green peas'], notitie: 'Kleine hoeveelheden (max ¼ kopje).' },
  ...
  { naam: 'Ui', emoji: '🧅', status: 'rood', engelsNaam: 'onion', zoektermen: ['uien', 'gele ui', 'witte ui', 'rode ui', 'sjalot', 'bieslook', 'onion'], notitie: 'Hoog FODMAP (fructanen) – vermijden, ook uienpoeder en gedroogde ui.' },
  ...
  { naam: 'Champignon', emoji: '🍄', status: 'rood', engelsNaam: 'mushroom', zoektermen: ['paddenstoel', 'paddestoelen', 'mushroom', 'shiitake', 'oesterzwam'], notitie: 'Hoog FODMAP (polyolen) – vermijden.' },
  { naam: 'Ui (lente-ui)', emoji: '🌿', status: 'rood', engelsNaam: 'spring onion', zoektermen: ['lente-ui', 'lente ui', 'bosui', 'bieslook', 'stengelui', 'spring onion'], notitie: 'Hoog FODMAP – het groene deel is veilig, de witte stronk vermijden.' },
  { naam: 'Prei', emoji: '🌿', status: 'rood', engelsNaam: 'leek', zoektermen: ['preistengel', 'leek', 'preiblad'], notitie: 'Hoog FODMAP – vermijden (de preistronk/bol bevat veel fructanen).' },
  ...
  { naam: 'Witlof', emoji: '🥬', status: 'rood', engelsNaam: 'chicory', zoektermen: ['witloof', 'chicory', 'cichorei'], notitie: 'Hoog FODMAP – vermijden.' },
  { naam: 'Kool', emoji: '🥬', status: 'rood', engelsNaam: 'savoy cabbage', zoektermen: ['savooiekool', 'groene kool', 'rode kool', 'witte kool', 'cabbage'], notitie: 'Hoog FODMAP – vermijden.' },
